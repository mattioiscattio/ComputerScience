...
namespace MultiFormProject {
    ...
    public partial class DSDB : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row AddTable1Row(string FullName, string AccessLevel, string DOB, string DateAdded) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public string AccessLevel {
                get {
                    try {
                        return ((string)(this[this.tableTable1.AccessLevelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableTable1.AccessLevelColumn] = value;
                }
            }
            ...
            public string DateAdded {
                get {
                    try {
                        return ((string)(this[this.tableTable1.DateAddedColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'DateAdded\' in table \'Table1\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable1.DateAddedColumn] = value;
                }
            }
            ...
            public bool IsAccessLevelNull() {
                return this.IsNull(this.tableTable1.AccessLevelColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetAccessLevelNull() {
                this[this.tableTable1.AccessLevelColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IsDateAddedNull() {
                return this.IsNull(this.tableTable1.DateAddedColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetDateAddedNull() {
                this[this.tableTable1.DateAddedColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace MultiFormProject.DSDBTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `AccessLevel` IS NULL) OR (`AccessLevel` = ?)) AND ((? = 1 AND `DOB` IS NULL) OR (`DOB` = ?)) AND ((? = 1 AND `DateAdded` IS NULL) OR (`DateAdded` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`FullName`, `AccessLevel`, `DOB`, `DateAdded`) VALUES (?, ?" +
                ", ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Table1` SET `FullName` = ?, `AccessLevel` = ?, `DOB` = ?, `DateAdded` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `AccessLevel` IS NULL) OR (`AccessLevel` = ?)) AND ((? = 1 AND `DOB` IS NULL) OR (`DOB` = ?)) AND ((? = 1 AND `DateAdded` IS NULL) OR (`DateAdded` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MultiFormProject.Properties.Settings.Default.Database11ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FullName, AccessLevel, DOB, DateAdded FROM Table1";
        ...
        public virtual int Fill(DSDB.Table1DataTable dataTable) {
        ...
        public virtual DSDB.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DSDB.Table1DataTable dataTable = new DSDB.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DSDB.Table1DataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_FullName, string Original_AccessLevel, string Original_DOB, string Original_DateAdded) {
        ...
        public virtual int Insert(string FullName, string AccessLevel, string DOB, string DateAdded) {
            if ((FullName == null)) {
            ...
            if ((DateAdded == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(DateAdded));
            }
        ...
        public virtual int Update(string FullName, string AccessLevel, string DOB, string DateAdded, int Original_ID, string Original_FullName, string Original_AccessLevel, string Original_DOB, string Original_DateAdded) {
            if ((FullName == null)) {
            ...
            if ((DateAdded == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(DateAdded));
            }
            ...
            if ((Original_AccessLevel == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_AccessLevel));
            }
            if ((Original_DOB == null)) {
            ...
            if ((Original_DateAdded == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_DateAdded));
            }
